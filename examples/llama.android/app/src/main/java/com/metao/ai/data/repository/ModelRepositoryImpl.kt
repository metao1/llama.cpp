...
class ModelRepositoryImpl(
    ...
    override suspend fun downloadModel(modelInfo: ModelInfo): Flow<DownloadState> =
        flow {
            ...
            val request =
                DownloadManager.Request(modelInfo.sourceUrl).apply {
    ...
    override suspend fun loadModel(modelPath: String): Flow<ModelLoadState> =
        flow {
